...
public class ConvertController {
    ...
    public ConvertController(ConvertService convertService, AccessCodeService accessCodeService) {
    ...
    public String blocks(Model model, @PathVariable String code) {
        accessCodeService.getAccessCodeByCode(code)
                .ifPresent(accessCode -> accessCode.setState(AccessCode.State.USED));
